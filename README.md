...
[🔗Here](Double_Walls_Overdamped_Langevin_Python/Diffusion.pdf) is the plot the parrallèle diffusion ${\color{#009de0}D_\parallel(z_t)}$ $${\color{#009de0}(in \space blue)}$$ and perpendicular diffusion $D_\perp (z_t)$ $${\color{#008000}(in \space green)}$$ in fonction of the height *z*<sub>t</sub>.

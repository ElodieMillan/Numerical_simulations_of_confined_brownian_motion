...
A particle of radius *a*, immersed in a fluid of viscosity *η*<sub>0</sub>, undergoing acceleration gravity *g* and confined between $${\color{#798997}two \space walls}$$ separated by a distance *2H*<sub>p</sub>, which diffuses in two dimensions (*x<sub>t</sub>, z<sub>t</sub>*).
